...
`bryanunitek/UniCORE.Valkey` is the **Valkey** family member: On-prem-deployment-shape public gift surface. Documentation today; source code at certification.

**Family purpose:** Open-source KV cache + pub/sub (Redis safe fork) — session cache, rate limiting, pub/sub for UniCORE.GVB.
...
UniCORE.Valkey is published as a **four-repo family**:

- `bryanunitek/UniCORE.Valkey` — public on-prem-deployment-shape gift surface ← **this repo**
- `bryanunitek/UniSaaS.UniCORE.Valkey` — public SaaS-deployment-shape gift surface
- `bryanunitek/UniCORE.Valkey-Claw` (private) — on-prem-shape working repository
- `bryanunitek/UniSaaS.UniCORE.Valkey-Claw` (private) — SaaS-shape working repository
...
- **Public discussion:** [GitHub Discussions](https://github.com/bryanunitek/UniCORE.Valkey/discussions)
